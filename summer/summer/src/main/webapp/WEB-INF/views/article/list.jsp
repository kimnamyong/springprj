...
<div class="container">
  ...
  <form:form method="get" modelAttribute="pagination" class="form-inline mb5">
    ...
    <form:hidden path="bd" />
    <span>순서:</span>
    <form:select path="od" class="form-control autosubmit"
                 itemValue="value" itemLabel="text" items="${ orderBy }" />
    <form:select path="si" class="form-control ml30"
                 itemValue="value" itemLabel="text" items="${ searchBy }" />
    <form:input path="si" class="form-control" placeholder="검색문자열" />
    <button type="submit" class="btn btn-default">
      <i class="glyphicon glyphicon-search"></i> 검색</button>
    <c:if test="${ pagination.si > 0 || pagination.sz > 0}">
